...
var view_container = document.getElementById('listing').getElementsByTagName('a');

function obj_start(){

    for (; box_index < view_container.length; box_index++ ) {
        init_set();
    }
...
function init_set() {
    container[box_index] = document.createElement( 'div' );
    view_container[box_index].appendChild( container[box_index] );
    container[box_index].className="container-3D-2nd";
    ...
    //
    var width = container[box_index].clientWidth;
    var height = container[box_index].clientHeight;
    ...
    container[box_index].appendChild( renderer.domElement );
